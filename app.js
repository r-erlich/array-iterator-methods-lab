...
let veryOldInventors = inventors.filter((age) => {
  return age.year < 1600 && age.year > 1500;
});
console.log(veryOldInventors);

// Check your work:
/*.log('Exercise 1 my result: ', veryOldInventors)
console.log(
...
const inventorNamed = inventors.find((inventor) => inventor.first === "Ada");
